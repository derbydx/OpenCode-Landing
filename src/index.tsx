...
function HeroSection(lc: LangContent, profileImage: string, lang: Lang, name: string): string {
  return `<section class="flex flex-col md:flex-row items-center gap-10 mb-24">
<div class="flex-1 text-center md:text-left">
<h1 class="text-5xl md:text-6xl font-extrabold tracking-tight text-white mb-2">${esc(name || 'Derby')}</h1>
...
${profileImage
  ? `<img src="${esc(profileImage)}" class="relative w-full h-full rounded-full object-cover border-2 border-gray-800" />`
...
function AboutSection(lc: LangContent, lang: Lang): string {
  return `<section id="about" class="mb-24">
...
function ServicesSection(lc: LangContent, lang: Lang): string {
  return `<section id="services" class="mb-24">
...
function ProjectsSection(lc: LangContent, lang: Lang): string {
  return `<section id="projects" class="mb-24">
...
function EducationSection(lc: LangContent, lang: Lang): string {
  return `<section id="education" class="mb-24">
...
function ConnectSection(lc: LangContent, lang: Lang): string {
  return `<section id="connect" class="mb-16">
...
${HeroSection(lc, content.profileImage, lang, content.name)}

<div class="border-t border-gray-800/50 mb-10"></div>
${AboutSection(lc, lang)}

<div class="border-t border-gray-800/50 mb-10"></div>
${ServicesSection(lc, lang)}

<div class="border-t border-gray-800/50 mb-10"></div>
${ProjectsSection(lc, lang)}

<div class="border-t border-gray-800/50 mb-10"></div>
${EducationSection(lc, lang)}

<div class="border-t border-gray-800/50 mb-10"></div>
${ConnectSection(lc, lang)}
</main>
...
<style>body{font-family:'Inter',sans-serif}.item-card{transition:all .2s}.item-card:hover{border-color:#0d9488!important}</style></head>
...
<section>
<h2 class="text-lg font-semibold text-teal-300 mb-3">Hero</h2>
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
<div class="space-y-3">
<h3 class="text-sm font-medium text-gray-400">English</h3>
<div><label class="block text-sm text-gray-400 mb-1">Tagline</label>${renderField('hero-tagline-en', content.en.hero.tagline)}</div>
<div><label class="block text-sm text-gray-400 mb-1">Subtitle</label>${renderField('hero-subtitle-en', content.en.hero.subtitle)}</div>
</div>
<div class="space-y-3">
<h3 class="text-sm font-medium text-gray-400">Español</h3>
<div><label class="block text-sm text-gray-400 mb-1">Tagline</label>${renderField('hero-tagline-es', content.es.hero.tagline)}</div>
<div><label class="block text-sm text-gray-400 mb-1">Subtitle</label>${renderField('hero-subtitle-es', content.es.hero.subtitle)}</div>
</div>
</div>
</section>
...
<section>
<h2 class="text-lg font-semibold text-teal-300 mb-3">About</h2>
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
<div><h3 class="text-sm font-medium text-gray-400 mb-1">English</h3>${renderField('about-en', content.en.about, { rows: 5 })}</div>
<div><h3 class="text-sm font-medium text-gray-400 mb-1">Español</h3>${renderField('about-es', content.es.about, { rows: 5 })}</div>
</div>
</section>
...
<h2 class="text-lg font-semibold text-teal-300">Skills</h2>
<button type="button" onclick="addSkill()" class="text-xs px-3 py-1 bg-teal-700 hover:bg-teal-600 rounded text-white">+ Add</button>
</div>
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
<div id="skills-en" class="space-y-2">${content.en.skills.map((sk, i) => `<div class="flex gap-2 items-center"><input name="skill-en-${i}" value="${esc(sk)}" class="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /><button type="button" onclick="this.parentElement.remove()" class="text-red-400 hover:text-red-300 text-sm px-2">x</button></div>`).join('')}</div>
<div id="skills-es" class="space-y-2">${content.es.skills.map((sk, i) => `<div class="flex gap-2 items-center"><input name="skill-es-${i}" value="${esc(sk)}" class="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /><button type="button" onclick="this.parentElement.remove()" class="text-red-400 hover:text-red-300 text-sm px-2">x</button></div>`).join('')}</div>
</div>
</section>
...
<section>
<div class="flex items-center justify-between mb-3">
<h2 class="text-lg font-semibold text-teal-300">Services</h2>
<button type="button" onclick="addService()" class="text-xs px-3 py-1 bg-teal-700 hover:bg-teal-600 rounded text-white">+ Add</button>
</div>
<div id="services-container" class="space-y-4">${content.en.services.map((sv, i) => serviceCardHTML(i, sv, content.es.services[i] || {title:'',desc:'',icon:'server',image:''})).join('')}</div>
</section>
...
<section>
<div class="flex items-center justify-between mb-3">
<h2 class="text-lg font-semibold text-teal-300">Projects</h2>
<button type="button" onclick="addProject()" class="text-xs px-3 py-1 bg-teal-700 hover:bg-teal-600 rounded text-white">+ Add</button>
</div>
<div id="projects-container" class="space-y-4">${content.en.projects.map((p, i) => projectCardHTML(i, p, content.es.projects[i] || {title:'',type:'',desc:'',tags:[],image:''})).join('')}</div>
</section>
...
<section>
<div class="flex items-center justify-between mb-3">
<h2 class="text-lg font-semibold text-teal-300">Education</h2>
<button type="button" onclick="addEdu()" class="text-xs px-3 py-1 bg-teal-700 hover:bg-teal-600 rounded text-white">+ Add</button>
</div>
<div id="edu-container" class="space-y-4">${content.en.education.map((e, i) => eduCardHTML(i, e, content.es.education[i] || {degree:'',institution:'',year:''})).join('')}</div>
</section>

<div class="border-t border-gray-800"></div>

<section>
<h2 class="text-lg font-semibold text-teal-300 mb-3">Connect</h2>
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
<div><h3 class="text-sm font-medium text-gray-400 mb-1">English</h3>${renderField('connect-en', content.en.connect.email)}</div>
<div><h3 class="text-sm font-medium text-gray-400 mb-1">Español</h3>${renderField('connect-es', content.es.connect.email)}</div>
</div>
</section>
...
function addSkill(){var enC=document.getElementById('skills-en');var esC=document.getElementById('skills-es');var ei=nextIdx('skill-en-');var esi=nextIdx('skill-es-');var dEn=document.createElement('div');dEn.className='flex gap-2 items-center';dEn.innerHTML='<input name="skill-en-'+ei+'" class="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /><button type="button" onclick="this.parentElement.remove()" class="text-red-400 hover:text-red-300 text-sm px-2">x</button>';enC.appendChild(dEn);var dEs=document.createElement('div');dEs.className='flex gap-2 items-center';dEs.innerHTML='<input name="skill-es-'+esi+'" class="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /><button type="button" onclick="this.parentElement.remove()" class="text-red-400 hover:text-red-300 text-sm px-2">x</button>';esC.appendChild(dEs)}
function svcHTML(i){var t='<div class="item-card p-4 rounded-xl bg-gray-900/40 border border-gray-800/60"><div class="grid grid-cols-2 gap-3 mb-3"><div><label class="block text-xs text-gray-500 mb-1">Icon</label><select name="svc-icon-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm">';['server','zap','database','shield','book','wrench'].forEach(function(n){t+='<option value="'+n+'">'+n+'</option>'});t+='</select></div><div><label class="block text-xs text-gray-500 mb-1">Image URL</label><input name="svc-image-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div class="space-y-3"><h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">English</h4><div><label class="block text-xs text-gray-500 mb-1">Title</label><input name="svc-title-en-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Description</label><input name="svc-desc-en-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div></div><div class="space-y-3"><h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">Español</h4><div><label class="block text-xs text-gray-500 mb-1">Title</label><input name="svc-title-es-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Description</label><input name="svc-desc-es-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div></div></div><button type="button" onclick="this.parentElement.remove()" class="text-xs text-red-400 hover:text-red-300 mt-3">Remove</button></div>';return t}
function addService(){var c=document.getElementById('services-container');var i=nextIdx('svc-icon');c.insertAdjacentHTML('beforeend',svcHTML(i))}
function projHTML(i){var t='<div class="item-card p-4 rounded-xl bg-gray-900/40 border border-gray-800/60"><div class="mb-3"><label class="block text-xs text-gray-500 mb-1">Image URL</label><input name="proj-image-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div class="space-y-3"><h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">English</h4><div><label class="block text-xs text-gray-500 mb-1">Type</label><input name="proj-type-en-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Title</label><input name="proj-title-en-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Description</label><input name="proj-desc-en-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Tags (comma separated)</label><input name="proj-tags-en-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div></div><div class="space-y-3"><h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">Español</h4><div><label class="block text-xs text-gray-500 mb-1">Type</label><input name="proj-type-es-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Title</label><input name="proj-title-es-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Description</label><input name="proj-desc-es-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Tags (comma separated)</label><input name="proj-tags-es-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div></div></div><button type="button" onclick="this.parentElement.remove()" class="text-xs text-red-400 hover:text-red-300 mt-3">Remove</button></div>';return t}
function addProject(){var c=document.getElementById('projects-container');var i=nextIdx('proj-image');c.insertAdjacentHTML('beforeend',projHTML(i))}
function eduHTML(i){return '<div class="item-card p-4 rounded-xl bg-gray-900/40 border border-gray-800/60"><div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div class="space-y-3"><h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">English</h4><div><label class="block text-xs text-gray-500 mb-1">Degree</label><input name="edu-degree-en-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Institution</label><input name="edu-institution-en-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Year</label><input name="edu-year-en-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div></div><div class="space-y-3"><h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">Español</h4><div><label class="block text-xs text-gray-500 mb-1">Degree</label><input name="edu-degree-es-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Institution</label><input name="edu-institution-es-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div><div><label class="block text-xs text-gray-500 mb-1">Year</label><input name="edu-year-es-'+i+'" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div></div></div><button type="button" onclick="this.parentElement.remove()" class="text-xs text-red-400 hover:text-red-300 mt-3">Remove</button></div>'}
function addEdu(){var c=document.getElementById('edu-container');var i=nextIdx('edu-degree-en');c.insertAdjacentHTML('beforeend',eduHTML(i))}
...
function serviceCardHTML(i: number, enSv: { title: string; desc: string; icon: string; image: string }, esSv: { title: string; desc: string; icon: string; image: string }): string {
  const opts = ICON_NAMES.map(n => `<option value="${n}"${n === enSv.icon ? ' selected' : ''}>${n}</option>`).join('')
...
<div><label class="block text-xs text-gray-500 mb-1">Image URL</label><input name="svc-image-${i}" value="${esc(enSv.image)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
</div>
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
<div class="space-y-3">
<h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">English</h4>
<div><label class="block text-xs text-gray-500 mb-1">Title</label><input name="svc-title-en-${i}" value="${esc(enSv.title)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Description</label><input name="svc-desc-en-${i}" value="${esc(enSv.desc)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
</div>
<div class="space-y-3">
<h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">Español</h4>
<div><label class="block text-xs text-gray-500 mb-1">Title</label><input name="svc-title-es-${i}" value="${esc(esSv.title)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Description</label><input name="svc-desc-es-${i}" value="${esc(esSv.desc)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
</div>
</div>
<button type="button" onclick="this.parentElement.remove()" class="text-xs text-red-400 hover:text-red-300 mt-3">Remove</button>
</div>`
}

function projectCardHTML(i: number, enP: { title: string; type: string; desc: string; tags: string[]; image: string }, esP: { title: string; type: string; desc: string; tags: string[]; image: string }): string {
  return `<div class="item-card p-4 rounded-xl bg-gray-900/40 border border-gray-800/60">
<div class="mb-3"><label class="block text-xs text-gray-500 mb-1">Image URL</label><input name="proj-image-${i}" value="${esc(enP.image)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
<div class="space-y-3">
<h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">English</h4>
<div><label class="block text-xs text-gray-500 mb-1">Type</label><input name="proj-type-en-${i}" value="${esc(enP.type)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Title</label><input name="proj-title-en-${i}" value="${esc(enP.title)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Description</label><input name="proj-desc-en-${i}" value="${esc(enP.desc)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Tags (comma separated)</label><input name="proj-tags-en-${i}" value="${esc(enP.tags.join(', '))}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
</div>
<div class="space-y-3">
<h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">Español</h4>
<div><label class="block text-xs text-gray-500 mb-1">Type</label><input name="proj-type-es-${i}" value="${esc(esP.type)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Title</label><input name="proj-title-es-${i}" value="${esc(esP.title)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Description</label><input name="proj-desc-es-${i}" value="${esc(esP.desc)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Tags (comma separated)</label><input name="proj-tags-es-${i}" value="${esc(esP.tags.join(', '))}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
</div>
</div>
<button type="button" onclick="this.parentElement.remove()" class="text-xs text-red-400 hover:text-red-300 mt-3">Remove</button>
</div>`
...
function eduCardHTML(i: number, enE: { degree: string; institution: string; year: string }, esE: { degree: string; institution: string; year: string }): string {
  return `<div class="item-card p-4 rounded-xl bg-gray-900/40 border border-gray-800/60">
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
<div class="space-y-3">
<h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">English</h4>
<div><label class="block text-xs text-gray-500 mb-1">Degree</label><input name="edu-degree-en-${i}" value="${esc(enE.degree)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Institution</label><input name="edu-institution-en-${i}" value="${esc(enE.institution)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Year</label><input name="edu-year-en-${i}" value="${esc(enE.year)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
</div>
<div class="space-y-3">
<h4 class="text-xs font-medium text-gray-500 uppercase tracking-wider">Español</h4>
<div><label class="block text-xs text-gray-500 mb-1">Degree</label><input name="edu-degree-es-${i}" value="${esc(esE.degree)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Institution</label><input name="edu-institution-es-${i}" value="${esc(esE.institution)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
<div><label class="block text-xs text-gray-500 mb-1">Year</label><input name="edu-year-es-${i}" value="${esc(esE.year)}" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-gray-200 text-sm focus:outline-none focus:border-teal-500" /></div>
</div>
</div>
<button type="button" onclick="this.parentElement.remove()" class="text-xs text-red-400 hover:text-red-300 mt-3">Remove</button>
</div>`
...
function isAuthed(c: Context, secret: string): Promise<boolean> {
...
app.post('/admin/init-defaults', async (c) => {
  c.header('Cache-Control', 'no-store')
  ...
  return c.json({ ok: true, message: 'Defaults written' })
})
